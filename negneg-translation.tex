...
\note{\justifying\footnotesize
  ...
  Prefixing every subformula with~$\neg\neg$ yields the XXX transformation.
  \par
}
...
\frame{\frametitle{Outlook}
  ...
  \centering
  \href{https://github.com/iblech/talk-constructive-mathematics}{github/iblech/talk-constructive-mathematics}
  \par
}
